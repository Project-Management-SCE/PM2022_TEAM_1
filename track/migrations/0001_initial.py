    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replay', models.CharField(default='There is no response to this message',
                                            max_length=500)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(0, 'male'),
                                                        (1, 'female'), (2, 'not specified')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(blank=True, null=True,
                                                  upload_to='profile_pic/NurseProfilePic/')),
                ('status', models.BooleanField(default=False)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE,
                                              to=settings.AUTH_USER_MODEL)),
            ],
